...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, MatCardModule, MatTableModule, MatButtonModule, MatIconModule, FormatDatePipe],
  template: `
    <div class="page-container">
      <div class="page-header">
        <h1>Manual Journals</h1>
        <button mat-flat-button color="primary"><mat-icon>add</mat-icon> New Journal</button>
      </div>
      <mat-card appearance="outlined">
        <table mat-table [dataSource]="data.journalEntries" class="full-width">
...
export class ManualJournalsComponent {
  readonly data = inject(DataService)
  cols = ['number', 'date', 'narration']
}
