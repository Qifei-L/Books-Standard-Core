...
export const items: Item[] = [
  {
    ...
    code: 'CONS',
    name: '咨询服务',
    description: 'Professional consulting — untracked service',
    itemType: 'Untracked',
    salesAccountId: 'a5',
  ...
  },
  {
    ...
    code: 'IMPL',
    name: '实施支持',
    description: 'Implementation and onboarding support',
    itemType: 'Untracked',
    salesAccountId: 'a5',
  ...
  },
  {
    ...
    code: 'VEH-DEMO',
    name: '示例 SUV（库存）',
    description: 'Tracked inventory item — COGS posts on delivery note',
    itemType: 'Tracked',
    salesAccountId: 'a5',
    inventoryAccountId: 'a8',
    cogsAccountId: 'a9',
  ...
  },
  {
    ...
    code: 'INST',
    name: '合同分期款',
    description: 'Installment billing line — revenue only, no inventory',
    itemType: 'Untracked',
    salesAccountId: 'a5',
    defaultUnitPrice: 0,
    taxRateLabel: 'VAT 10%',
...
export const inventoryAdjustments: InventoryAdjustment[] = [
  {
    ...
    date: '2025-06-01',
    reason: 'stocktake',
    narration: 'Annual count — 1 unit variance',
    status: 'Posted',
    lines: [
      {
        id: 'adjl1',
